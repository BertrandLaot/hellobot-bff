...
├── products/             # Module Products (GET /products/:id)
├── modules/              # Module Modules (GET /modules/:id)
...
### Modules exposés
- **ProductsModule**: `GET /products/:id` - Récupère un produit depuis le backend
- **ModulesModule**: `GET /modules/:id` - Récupère un module depuis le backend
...
async getData(id: string) {
  return this.backendApiService.get(`/endpoint/${id}`);
}
```
